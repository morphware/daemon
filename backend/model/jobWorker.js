...
class JobWorker extends Job {
  ...
  */
  ...
  // only one job is allowed to be worked on at a given time. This set to true when a job is being worked on.
  static lock = false;
  ...
  */
  ...
  // when there is no modeling running, utilize the global mining command to mine other coins.
